...
Outline the steps to download the core software, and handle any required
prerequisites.
...
site. See <<install-requirements>> for a list of requirements.

See <<install-ddev>> for the recommended way to get started running the software
locally.
