...
Uninstall the core Search and History modules, as well as the core Actions UI module if you installed it in <<config-install>>, to reduce overhead.
...
_Actions UI_). Click _Uninstall_ at the bottom of the page.
+
--
// Top part of admin/modules/uninstall, with Actions UI checked.
...
+
--
// Uninstall confirmation screen, after checking Actions UI, History,
...
information area for the module. For instance, the core Actions UI
module's machine name is _action_.
