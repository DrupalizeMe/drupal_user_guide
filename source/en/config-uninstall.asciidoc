...
Uninstall the core Search and History modules, as well as the core Ban module if you installed it in <<config-install>>, to reduce overhead.
...
. Check the boxes for the modules you are uninstalling (_Ban_, _History_, and _Search_). Click _Uninstall_ at the bottom of the page.
+
--
// Top part of admin/modules/uninstall, with Ban checked.
...
+
--
// Uninstall confirmation screen, after checking Ban, History,
...
Written and edited by https://www.drupal.org/u/eojthebrave[Joe Shindelar] at https://drupalize.me[Drupalize.Me], https://www.drupal.org/u/surendramohan[Surendra Mohan],
