...
A module is a package of files that extends Drupal's core functionality. Modules
typically contain PHP code, configuration (YAML), and may include JavaScript,
CSS, and Twig template files.
