...
core Olivero theme provides the regions highlighted in the following image.
...
image:images/block-regions-olivero.png["core Olivero theme regions",width="100%"]
