...
check the box for the core Actions UI module.
+
--
// Top part of Core section of admin/modules, with Actions UI checked.
image:images/config-install-check-modules.png["Enabling the core Actions UI module",width="100%"]
--
