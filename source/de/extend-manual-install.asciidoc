...
* https://www.drupal.org/docs/8/extending-drupal-8/installing-drupal-8-modules[_Drupal.org_ Community-Dokumentationsseite „Installieren der beigetragenen Module (Drupal 9) (englisch)"]
