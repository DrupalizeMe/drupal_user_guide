...
[[glossary-entity-subtype]] Entitätssubtyp::
   ...
   Jeder Subtyp enthält dabei seine eigenen Felder. Auch der Begriff _Bündel_ wird als Bezeichung solcher Elemente verwendet
   (besonders in Dokumentationen für Entwickler, wo meist das englsiche Wort Bundle verwendet wird).
   Siehe: <<planning-data-types>> für weitere Informationen.
...
[[glossary-reference-field]] Referenzfeld::
   ...
   kann ein Rezept auf der Website des Wochenmarktesein Referenzfeld zum Eintrag eines Lieferanten enthalten der das Rezept eingereicht hat. Der Eintrag des Lieferanten wurde in diesem Fall ebenfalls als Inhalt erzeugt. 
...
[[glossary-region]] Region::
   ...
   Regionen werden in <<glossary-theme,Themes>> definiert, Der Inahlt, der in jeder dieser Regionen dargestellt wird, ist Inhalt, der mit Hilfe von <<glossary-block,Blöcken>> dargestellt wird. 
