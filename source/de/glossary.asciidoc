...
[[glossary-vocabulary]] Vokabular::
   Eine Gruppe von <<glossary-taxonomy-term,Taxonomiebegriffen>> aus denen  der Richtige Begriff gewählt werden kann wenn <<glossary-content,Inhalte>> auf eine bestimmte Art und Weise klassifiziert werden sollen. Wie im Beispiel aller Leiferanten des Wochenmarktes. Technisch gesheen sind Taxonomiebegriffe ein
   <<glossary-entity-subtype,Subtyp>> eines Vokabulars.
