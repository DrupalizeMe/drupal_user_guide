...
[[glossary-reference-field]] Referenzfeld::
   ...
   kann ein Rezept auf der Website des Wochenmarktes ein Referenzfeld zum Eintrag eines Lieferanten enthalten der das Rezept eingereicht hat. Der Eintrag des Lieferanten wurde in diesem Fall ebenfalls als Inhalt erzeugt. 
