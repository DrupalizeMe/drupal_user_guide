...
[[glossary-entity-subtype]] Entitätssubtyp::
   ...
   <<glossary-content-item,Inhalt>> beschrieben, dass die auf der Wochenmarkt-Website verwendeten Entitätstypen Entitätssubtypen des Entitätstyps <<glossary-content-type,Inhalt>>) sind. Ein Subtyp wird auf der Website für statische Seiten erwendet, während ein anderer Subtyp dazu verwende wird Informationen über Lieferanten zu erfassen und auf der Website darzustellen.
