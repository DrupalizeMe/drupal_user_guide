...
[[glossary-user-one]] Der erste Benutzer (User 1)::
   Das Konto des ersten <<glossary-user,Benutzers>>, das bei der Installation der Website erstellt wird (und deshalb die Nummer 1 erhält). Es besitzt automatisch alle 
