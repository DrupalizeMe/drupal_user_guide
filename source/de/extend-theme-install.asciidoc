...
verwendet haben, dann können Sie fortfahren mit diesem Schritt, und erreichen
Sie die Seite _Design_ mit der Funktion _Verwaltung_ Verwaltungsmenü und
navigieren zum Menüpunkt _Design_ (_admin/appearance_).
