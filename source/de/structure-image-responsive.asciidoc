...
Dies ist hilft beispielsweise dabei Ihrer Website auf mobilen Geräten schnneller zu laden, da unter Verwendung des Moduls responsive Imgae erzeugte Bilder für kleinerere Bildschirme optimiert sind.
