...
|Core compatibility |Die Version des Kernsystems von Drupal, mit der das Theme kompatibel ist.|8.x
|Status |_Sandbox projects_ are experimental projects. _Full projects_ haben bereits einen Genehmigungsprozess durchlaufen, können sich aber immer noch in der entwicklung befinden.|Full projects
...
video::https://www.youtube-nocookie.com/embed/M8LYX6K53jg[title="Themes evaluieren"]
