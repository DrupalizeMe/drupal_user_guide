...
Die Seiten Startseite und Über den Wochenmarkt müssen im Hauptnavigationsmenü vorhanden sein.
...
. Verwenden Sie das Drag-Handle (die Schaltfläche zum anordnen von Menüeinträgen),
  um die Reihenfolge der Menüeinträge innerhalb des Menüs zu ändern:
  Beginnen Sie das Menü mit der Startseite (Home), und legen Sie als nöchsten
  Eintag die Seite (Über uns) fest. Als Alternative zur Verwendunbg des Drag-Handles
