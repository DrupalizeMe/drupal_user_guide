...
Die Seiten Startseite und Über den Wochenmakt müssen im Hauptnavigationsmenü vorhanden sein.
...
Installationsprofil angelgt wurden auf dieser Seite auf Englisch
...
um die Reihenfolge der Menüeinträge innerhalb des Menüs zu ändern: Beginnen Sie das Menü mit der Startseite (Home), und legen Sie als nöchsten Eintag die Seite (Über uns) fest. Als Alternative zur Verwendunbg des Drag-Handles
