...
. Suchen Sie das den Inhlat vom Typ „Liueferant" aus Schritt 1 erneut, und lassen Sie sich die Seite erneut anzeigen, um zu überprüfen, ob die von Ihnen vorgenommenen Änderungen gespeichert wurden.
