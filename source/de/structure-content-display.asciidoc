...
. 'Ändern  Sie die Sortierreihenfolge der Felder über die 'Drag-Handle', so dass das Hauptbild vor dem Txtkörper des Inhalts angezeigt wird, danach der Link zur Website des Lieferanten . Alternativ zur Verwendung der Schaltfläche zum Ziehen und Umsortieren können Sie auf den Link _Zeilenreihenfolge anzeigen_ oben in der Tabelle klicken und den Feldern nummerische Gewichtungswerte zuweisen (Felder
