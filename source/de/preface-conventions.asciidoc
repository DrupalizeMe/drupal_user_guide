...
auf Ihrer Website bereits abgeschlossen haben müssen, bevor Sie die Aufgabe, die
in einem Thema behandelt wird, das sie gerade lesen, umsetzen können.
...
Das Wort Info  wäre nicht kursiv dargestellt, weil die Info-Seite in einem vorgegangenen Thema behandelt worden währe).
...
=============
Navigieren Sie im Menü _Verwalten_ zum Menüpunkt
_Konfiguration_ > _System_ > _Grundlegende Website-Einstellungen_
...
und dort auf den Link _Grundlegende Website-Einstellungen geklickt haben_. Danach landen Sie auf der Seite
...
werden viele „Hinzufügen"-Button im Verwaltungsberiech mit \+-Zeichen angezeigt.
...
|Grundeinstellugen der Website > Name der Website|Name Ihrer Website|Musterstadt Wochenmarkt
|================================
...
(z. B. auf _Grundelegende Einstellungen der Website_), um einem Formularabschnitt auszuklappen, um das jeweilige Feld sehen zu können.
