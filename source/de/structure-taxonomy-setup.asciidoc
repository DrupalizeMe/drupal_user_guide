...
Erstellen Sie ein Zutantenvokabular und fügen Sie es dem Inhaltstyp Rezept als
Feld hinzu, das eine unbegrenzte Anzahl von Werten enthalten kann.
...
Beschreibungen dieses Vokabulars auf der Seit auf englisch angezeigt werden; Siehe
...
. Sie erhalten eine Bestätigung darüber, dass der von ihnen erstellte Begriff zum vorkabilar hinzugefügt wurde. Fügen Sie nun merh Zutaten hinzu. Zum Beispiel „Eier" und „Milch".
...
|Referenztyp > Referenzierte Entitäten erstellen, falls sie noch nicht existieren | Ob neue Zutaten aus dem Formular heraus angelgt werden können | Angehagt
|================================
+
--
