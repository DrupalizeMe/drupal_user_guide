...
. Suchen Sie das Konto von Benutzer 1 (mit dem Namen "admin"), um diesem die Rolle _Administrator_ zuzuweisen. Wenn es nicht sofort sichtbar ist, verwenden Sie den Filter _Name oder E-Mail enthält_,
...
.  Blättern Sie auf der Seite _Bearbeiten_ zum Abschnitt _Rollen_. Aktivieren Sie den Haken bei der Rolle _Administrator_ für das Benutzerkonto.
+
--
...
.  Klicken Sie auf _Speichern_, um das Benutzerkonto zu aktualisieren. Sie sollten dadurch zur _Personen_ Seite zurückkehren und sehen eine Meldung, dass die Änderungen gespeichert wurden.
+
--
...
zeigen wir hier, wie Sie diese hinzufügen können. Navigieren Sie im Verwaltungsmenü _Verwalten_ zu
...
. Wählen Sie _Hinzufügen der Rolle Lieferant zu dem/den ausgewählten Benutzer(n)_ aus der oben stehenden Liste _Aktion_
aus.
+
--
