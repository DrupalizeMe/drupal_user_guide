...
. Navigieren Sie im Meneü _Verwalten_ zum Menüpunkt _Inhalt_ (_admin/content_).
...
|Beschreibung |Text, der angezeigt wird, wenn ein Besuchermit dem Mauszeiger über einen Link fährt
  |Geschichte des Marktes
|Übergeordnetes Element |Platierung der Seite in der Menühhirarchie.
...
|Gewichtung|Die Stellle, in der Reinfolge der Links in der Sich der menüeintrag im Menü einreihen soll (niedriger gewichtete
