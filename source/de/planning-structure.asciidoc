...
Inhalten verwendet werden sollen und auf Welchen Seiten welche Inhalte
...
. Entscheiden Sie für jedes identifizierte Stück Inhalt, welcher
...
. Entscheiden Sie für jede Unterart des Entitätstyps Inhalt, die Sie auf
  ...
  Lieferant benötigt z. B. möglicherweise Felder für den den Namen des
...
. Entscheiden Sie, welche Entitäten als Listen dargestellt werden sollen.
  ...
  Liste geben, die,Inhalte vom Typ
  Rezept auflistet.Diese Rezepte sollen nach den darin enthaltenen Zutaten
...
- Ob die Eingabewerte für diese Felder aus einer Liste zulässiger Begriffe
  ausgewählt werden sollten oder ob ein Feld Begriffe enthält, die zukünftig
  weiter ergänzt werden müssen.  Diese Art Felder sind gute Kandidaten für
  Taxonomiebegriffe. Ein Beispiel ist das Feld Zutaten für den Inhaltstyp Rezept.
