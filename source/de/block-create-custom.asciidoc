...
[role="summary"]
Einen benutzerdefinierten Block erstellt.
...
. Navigieren Sie im Menü _Verwaltung_ zum Menüpunkt _Struktur_ > _Block
...
. Klicken Sie auf _Speichern_. Es erscheint eine Meldung,
...
(Inhalt in Abschnitten (Regionen))], copyright 2000 - copyright_upper_year von den einzelnen Beitragenden zu
die https://www.drupal.org/documentation[Dokumentation der Drupal-community].
