...
Zusatzmodule und Themes sowie vordefinierte Konfigurationen bereitstellt.
...
* https://www.drupal.org/docs/8/install/step-3-create-a-database[Drupal.org Community-Dokumentationsseite https://secure.php.net/manual/de/configuration.phpEine Datenbank erstellen (englisch)"]
* https://www.drupal.org/server-permissions[Drupal.org Gemeinschaft Dokumentation Abschnitt https://secure.php.net/manual/de/configuration.phpWebhosting-Probleme (englisch)"]
