...
alle der folgenden Bildschirme als Teil des Installationsprozess übersprungen.
...
_Drupal wird instlliert_ angezeigt. Nachdem der Installationsvorgang abgeschlossen
wurde, wechselt das Installationsprogramm automatisch zu zum nächsten Schritt.
+
--
...
sowohl das Verzeicnis, als auch die Datei schreibgeschützt sind
