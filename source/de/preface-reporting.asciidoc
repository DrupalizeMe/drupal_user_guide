...
. Prüfen Sie, ob das von Ihnen gefundene Problem nicht bereits in eiem anderen Problmbericht gemeldet wurde:
  ...
  * Wenn die Liste der offenen Problemberichte länger ist, geben Sie eintwerde ein in Zusammenhang mit dem von Ihnen gefundenen Problem stehendes Schlüsselwort oder den Titel, des Kapitels, in dem das Problem auftritt in das Eingabefeld
