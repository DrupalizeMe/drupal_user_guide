...
werden. Die meisten Entitätstypen werden zusätzlich in _Entitäts-Subtypen_ unterteilt,
die einen Entitätstyp noch genauer unterteilen, um kleinere Variationen bei
...
|Taxonomie-Begriff |Vokabular |Taxonomy
          ...
          | 3+| *Beispiel:* Im Beispiel der Website des Wochenmarktes könnten Sie Rezepttinhalte
          mitels eines Taxonomievokabulars für Zutaten, mit Taxonomie-Begriffen wie
          Karotten und Tomaten klassifizieren. Auf einer Blogging-Website können Blog-Beiträge klassifiziert werden
