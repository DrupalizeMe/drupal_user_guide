...
Mitwirken::
  ...
  * Der Entwicklung von Modulen oder Themes. Lesen Sie dazu die Seite
    ...
    auf _Drupal.org_] (englisch), oder helfen Sie mit, indem Sie mithelfen Module und Themes zu verbessern (dazu können Sie Probleme und Verbesserungsvorschläge in die sogenannten Issue-Queues von bestehenden
    Projekten eintragen).
