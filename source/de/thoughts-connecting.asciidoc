...
Chatten Sie online::
  Das Drupal-Projekt verwendet IRC für Online-Chats. Es sind regionale sowie Themen zugeordnete Chats als auch
...
Ein Problem melden::
  Siehe unten.
Mitwirken::
  Sie können Ihre Zeit und Ihr Fachwissen auf vielfältige Weise in die Gemeinschaft einbringen.
  z. B. mit:
  ...
  * Mit der Beantwortung von Sie Support-Anfragen. Siehe: <<thoughts-support>>.
...
Software-Fehler und Pläne für neue Funktionen zu verfolgen. Sie können sich beteiligen, indem Sie einen Fehlerberiecht erstellen, wenn Sie ein Problem finden,
eine Anfrage für ein neues Feature stellen, oder bestehende Fragen kommentieren.
Suchen Sie zunächst nach dem Problem oder nach dem Feature, für das Sie ein Ticket erstellen möchten, bevor Sie damit beginnen, um
sicherstellen, dass das Problem oder die Funktion nicht bereits gemeldet oder
angefordert worden ist. Lensen Sie hierzu auch:
...
Wenn Sie ein Problem finden, das Ihrer Meinung nach sicherheitsrelevant ist, wie z.B. ein
