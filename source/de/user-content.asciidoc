...
. Im Abschnitt _Informationen zum Autor_: Geben Sie im Feld _Geschrieben von_ das Benutzerkonto des Lieferanten _Happy Farm_ ein. Die Liste gibt die passenden Benutzernamen aus. 
...
. Führen Sie diese Schritte erneut aus, um den Inhalt des Lieferanten Sweet Honey dem
Benutzerkonto des Lieferanten Sweet Honey zuzuordnen.
