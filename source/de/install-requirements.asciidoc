...
um Drupal verwenden zu können vorinstalliert. Wenn Sie Ihre Website selbst hosten oder
...
Lokaler PHP-Server::
  ...
  damit zur Evaluierung von Drupal kein zusätzlicher Websiter installiert werrden muss.
