...
=== Konzept: Verteilungen

[role="summary"]
Übersicht über die Distributionen, die zur Einrichtung von Websites für bestimmte
Zwecke.
...
als ein einziger Download, der die Kern-Software, beigetragene Module und Themen enthält,
...
Voll funktionsfähige Distributionen::
  ...
  könnte Ihre Einrichtung für die Bauernmarkt-Website als Vertrieb für
  andere zu verwenden.
