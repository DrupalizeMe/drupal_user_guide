...
_Konfiguration_ > _System_ > _Grundlegende Information der Website_
...
https://www.drupal.org/node/1896670[_Drupal.org_ Community-Dokumentationsseite „Erste Schritte in der Administration von Druppal 9" (englisch)]
