...
Besucher der Wbsite darüber zu informieren, dass der Wartungsmodus aktiviert ist. Variablen wie @site können in der Nachricht verwendet werden.
...
. Füllen Sie die Felder, wie untenstehend gezeigt aus:
+
[width="100%",frame="topbot",options="header"]
|================================
