...
GNU General Public License (GPL), Version 2 oder neuer. lizenzhiert. Das bedeutet, dass Sie die Freiheit haben diese Dateien
...
* Drupal-Module und -Themes sind derivative Werke von Drupal. Wenn Sie
  Drupal weitergeben müssen Sie dies unter den Bedingungen der GPL Version 2
  oder neuer tun.
