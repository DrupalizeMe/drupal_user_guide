...
. Überprüfgen Sie die Einstellungen des Entitätstyps anhand der untenstehenden Tabelle:
+
...
| Geändert am | Datium der letzten Aktualisierung | Ausgewählt
| Auf der Startseite veröffentlicht | Ob der Inhalt in Ansichten enthalten ist oder nicht | Nicht ausgewählt
| Oben in Listen | Ob der Inhalt oben in Listen angezeigt wird oder nicht | Nicht ausgewählt
| URL-Alias | Nicer URL for the content | Ausgewählt
