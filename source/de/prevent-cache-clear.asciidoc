...
Sie können entweder die Benutzeroberfläche oder Drush verwenden, um den Cache zu leeren. Sie können
...
Nachdem der Befehl ausgeführt wurde, wird die Meldung „Cache rebuild
complete" ausgegeben.
