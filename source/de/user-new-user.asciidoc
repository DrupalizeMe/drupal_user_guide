...
|Benutzername |Ein Benutzername für den Lieferanten, den dieser zur Anmeldung oder zum Verfassen von Inhalten verwendet. Leerzeichen sind erlaubt; Satzzeichen sind nicht erlaubt, mit Ausnahme von Punkten, Bindestrichen, Apostroph-Zeiuchen und Unterstriche. |Sweet Honey
