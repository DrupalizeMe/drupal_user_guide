...
|Passwort |Ein Passwort, mit dem sich der Anbieter bei der Website anmeldet. Wie sicher das Kennwort ist, können Sie an der _Passwortstärke_ ablesen. Sie erhalten auch Tipps, wie Sie es sicherer machen können.  |(Machen Sie ein sicheres Passwort)
...
|Benutzer über neues Konto benachrichtigen |Ob oder nicht, um eine Benachrichtigung an die E-Mail-Adresse des Anbieters zu senden. | Ausgewählt
|Bild |Klicken Sie auf _Blättern_ und wählen Sie ein Bild zum Hochladen aus. Achten Sie auf Größenbeschränkungen. |Foto des Anbieters
...
. Erstellen Sie ein zweites Benutzerkonto für den Lieferanten Glücklicher Bauerrnhof, indem Sie die oben angegebenen Schritte wiederholen.
