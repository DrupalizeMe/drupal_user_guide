...
[role="summary"]
Die Einstellungen eines Themes bearbeiten,
...
Bearbeiten Sie die Einstellungen des Standard-Themes des Kernsystems
...
. Unter _Installierte Themes_, sehen Sie das Theme Bartik, dass dort als
...
|Hintergrundfarbe der Seitenleisten| #f8bc65 (hellorange)
|Farbe der Umrandung der Seitenleisten| #e96b3c (orange)
|Hintergrund der Fußzeile| #2a3524 (dunkelgrün)
...
um die von Ihnen gewünschten Farben auszuwählen.
...
image:images/config-theme_logo_upload.png["Neues Logo in den Einstellungen des Kernsystemthemes Bartik"]
--
...
_Design_ > _Globale Einstellungen_ (_admin/appearance/settings_).
...
video::https://www.youtube-nocookie.com/embed/CEi3i1YGOs0[title="Ein Theme konfigurieren (english)"]
