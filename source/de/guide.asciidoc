...
[role="summary"]
Überblick über Konzepte zur inhaltssturkturierung. Aufgaben zu inhaltstypen, Taxonomien und Referenzfeldern werden hier behandelt.
...
== Ihre Website in mehreren Sprachen ausgeben
...
[[extend-chapter]]
== Ihre Website erweitern und anpassen
...
[role="summary"]
Überblick über Sicherheits- und Wartungskonzepte. Aufgaben im zusammenhjang mit der Aktualisierung des Kernsystems, Modul- und Theme-Aktualisierunge werden hier behandelt.
