...
[role="summary"]
Überblick über das Anpassen und Entwickeln von Drupal-Überblick über das Erstellen von Drupal-Websites. Aufgaben im Zusammenhang mit dem Herunterladen und aktivieren von Themes werden behandelt.
