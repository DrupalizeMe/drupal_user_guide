...
. Aller à _https://www.drupal.org_ et naviguer vers _Build_ > _Download &
...
. Si vous voulez juste télécharger le cœur, cliquer sur un des liens _Download
...
. Transférer le fichier télécharger chez votre hébergeur. Se connecter au
