...
8.x-1.7 d'un module contribué, vous saisiriez juste 1.7, tandis que pour la
version 8.3.1 du cœur, vous saisiriez 8.3.1. Saisir ensuite la commande suivante
