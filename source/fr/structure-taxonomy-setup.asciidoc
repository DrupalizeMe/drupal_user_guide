...
Choisir le type de champ _Référence_ dans les options _Choisir un type de
champ_. La page _Ajouter un champ_ apparaît. Elle contient un formulaire
permettant de configurer le champ.
+
--
// Add field page to add Ingredients taxonomy reference field.
image:images/structure-taxonomy-setup-add-field.png["Ajouter un champ Ingrédients au type de contenu Recette"]
--

. Saisir les valeurs du tableau ci-dessous. Cliquer sur _Continuer_.
+
[width="100%",frame="topbot",options="header"]
|================================
| Nom du champ | Explication | Valeur exemple
| Étiquette | Le titre à donner au champ | Ingrédients
| Choisir une option ci-dessous : | Type de contenu à référencer | Terme de taxonomie
|================================
+
--
// Add field page to add Ingredients taxonomy reference field.
image:images/structure-taxonomy-setup-add-field-label.png["Paramètres du champ Ingrédients"]
--

. Sur l'écran de configuration suivant, saisir les valeurs du tableau
ci-dessous. Cliquer sur _Enregistrer les paramètres_.
+
[width="100%",frame="topbot",options="header"]
|================================
...
|Type de référence > Méthode de référence | Sélectionner la méthode utilisée pour choisir les valeurs autorisées | Par défaut
|Type de référence > Vocabulaire | Sélectionner le vocabulaire dans lequel les valeurs sont choisies | Ingrédients
...
image:images/structure-taxonomy-setup-field-settings-2.png["Paramètres du champ
de type référence",width="100%"]
--
