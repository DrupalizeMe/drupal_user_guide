...
champ_. Cliquer sur _Continuer_. La page _Ajouter un champ_ apparaît. Elle
contient un formulaire pour configurer l'étiquette du champ.
+
--
...
Remplir les champs comme montré ci-dessous. Cliquer sur _Enregistrer et
continuer_.
+
...
| Choisir un option ci-dessous : | Type de contenu à référencer | Contenu
|================================
+
--
// Add field page for adding a Submitted by field to Recipe.
image:images/structure-adding-reference-add-field-label.png["Ajouter un champ de type
référence à un type de contenu"]
--
