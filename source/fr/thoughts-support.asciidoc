...
Le projet Drupal est un logiciel libre et open source. En conséquence, si vous avez
des questions à propos du logiciel ou que vous rencontrez des problèmes, les possibilités
pour trouver des réponses et des solutions sont différentes de
