...
exemple, cocher la case pour le module Ban.
+
--
// Top part of Core section of admin/modules, with Ban checked.
image:images/config-install-check-modules.png["Activation du module du cœur Ban",width="100%"]
--
...
zone d'information pour le module. Par exemple, le nom machine du module du
cœur Ban est _ban_.
...
Ecrit et modifié par https://www.drupal.org/u/batigolix[Boris Doesborg],
