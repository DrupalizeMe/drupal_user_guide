...
(((Annonce de sécurité critique)))
(((Annonce de sécurité,s'inscrire par courriel)))
(((Annonce de sécurité,s'inscrire sur X)))
...
* Les annonces de sécurité hautement critiques seront affichées sur les pages
d'administration de votre site. Un lien vers l'annonce sur Drupal.org y
apparaîtra. Vous y trouverez plus d'informations sur le moment et la manière de
...
* https://x.com/drupalsecurity[@drupalsecurity sur Twitter]
