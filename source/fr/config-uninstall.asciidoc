...
Ban si vous l'avez installé dans <<config-install>>, pour réduire la charge
système.
...
. Cocher les cases pour les modules que vous désinstallez (_Ban_, _History_ et
_Search_). Cliquer sur _Désinstaller_ en bas de la page.
+
--
...
. Trouver le nom machine du module que vous voulez désinstaller, en affichant la
zone d'information pour le module. Par exemple, le nom machine du module du cœur
Ban est _ban_.
...
https://www.drupal.org/u/surendramohan[Surendra Mohan], et
