...
Texte du contenu et fichiers::
  Si votre site est multilingue, vous pouvez configurer les champs du contenu de
  votre site de manière à ce qu'ils soient traduisibles. Après avoir créé du
  contenu dans une langue, vous pouvez le traduire dans d'autres langues. Les
  champs peuvent contenir de l'information textuelle ou des fichiers transférés,
  et pour chaque champ de chaque type de contenu, vous pouvez le configurer de
  manière à ce qu'il soit traduisible ou non. Il faut que le module du cœur
  Content Translation soit installé afin de traduire ce type de texte.
