...
* Le thème du coeur Olivero doit être installé et utilisé par défaut.
...
. Vous asssurer dans le deuxième onglet que le thème du coeur Olivero est
...
image:images/block-place-configure-block.png["Page de configuration des blocs",width="100%"]
--
...
utilisent le thème du cœur Olivero.
+
--
// About page with placed sidebar block.
image:images/block-place-sidebar.png["Page comprenant un bloc placé dans la deuxième barre de navigation",width="100%"]
--

==== Améliorer votre compréhension

* Supprimer le block _Propulsé par Drupal_ de la région _Cinquième pied de page_
en cliquant sur _Désactiver_ ou _Retirer_ dans le bouton déroulant _Opérations_.
