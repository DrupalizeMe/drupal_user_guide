...
[role="summary"]
Vue d'ensemble des concepts d'organisation de votre site et détails sur des
tâches courantes de mise en page d'un site. Ces chapitres couvrent les concepts
relatifs aux entités de contenu et à la structure.
...
[role="summary"]
Vue d'ensemble des concepts relatifs à la configuration élémentaire d'un site.
Les tâches liées à l'installation, les paramètres des comptes d'utilisateurs et
les thèmes sont traitées dans ces chapitres.
...
[role="summary"]
Vue d'ensemble des concepts relatifs à la structure du contenu. Les tâches
relatives aux types de contenus, taxonomies et champs de type références sont
traités dans ces chapitres.
...
[role="summary"]
Vue d'ensemble de la personnalisation et du développement d'un site. Les tâches
liées au téléchargement de modules et de thèmes sont traitées dans ces
chapitres.
...
journalisation. La manière de vider le cache est traitée dans ces chapitres.
...
[role="summary"]
Vue d'ensemble des concepts de sécurité et de maintenance. Les tâches liées à la
mise à jour du cœur, des modules et des thèmes sont traitées dans ces chapitres.
