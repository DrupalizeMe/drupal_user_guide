...
|Slogan|Utilisé différemment selon le thème de votre site. Non affiché par
défaut si vous utilisez le thème Olivero.|Aliments frais de la ferme
...
https://erdfisch.de[erdfisch], https://www.drupal.org/u/ifrik[Antje Lorch] et
